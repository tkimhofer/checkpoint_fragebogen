...
export default function CollectorWorkspace({
  ...
  const renderBesucherInfo = ({ qid,  }: RenderCtx) => {
    return(
          <TwoInputRow
  ...
  async function submitResponses() {
    ...
    try {
        ...
        if (backend === 'datenbank') {
          ...
          const url =  buildApiUrl(base, "/ingest/submissions");
          console.log('url - submit', url)
          r = await submitPayload(url, payload, apiToken)
        } else{
          console.log('local json submit', dataFolder)
                ...
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    <div className="text-xs text-amber-900/80">
                      {openedEntryMeta?.entryId ? `Besucher: ${openedEntryMeta.entryId} · ` : ""}
                      {openedEntryMeta?.createdAt ? `Berater: ${openedEntryMeta.createdAt}` : ""}
                    </div>
                  </div>
...
{/* 
            ...
            <Tabs
              ...
              >
                ...
                <TabsTrigger value="hiv" disabled={hivDisabled} className={clsx(tabTriggerBase, hivDisabled && "opacity-50")}>HIV-Risiko</TabsTrigger>
                ...
                <div className="flex-1">
                  <TabsContent value="general">
                    ...
                    <div className="flex justify-end">
                        <Button onClick={() => { setActiveTab(section_after_allgemein);}}>Weiter zu: {section_after_allgemein_str}</Button>
                    </div>
                  </TabsContent>
                  ...
                  <TabsContent value="hiv">
                    ...
                    <div className="flex justify-end">
                        <Button onClick={() => { setActiveTab("sexpractices"); }}>Weiter zu: Sex & Schutz</Button>
                    </div>
                  </TabsContent>
                  ...
                  <TabsContent value="sexpractices">
                    ...
                    <div className="flex justify-end">
                      <Button onClick={() => { setActiveTab("other"); }}>Weiter zu: Gesundheit &amp; Vorsorge</Button>
                    </div>
                  </TabsContent>
                  ...
                  <TabsContent value="other">
                    ...
                    <div className="flex justify-end">
                      <Button onClick={() => { setActiveTab("berater"); }}>Weiter zu: Beratereingaben</Button>
                    </div>
                  </TabsContent>
